/**
 * carousel.js � Planet Carousel (�rbita Central)
...
(function () {
  ...
  var PLANETS = [
    { slug: 'calculon',  name: 'Calculon',  subject: 'Matem�tica' },
    { slug: 'letrion',   name: 'Letrion',   subject: 'Portugu�s'  },
    { slug: 'naturox',   name: 'Naturox',   subject: 'Ci�ncias'   },
    { slug: 'terramund', name: 'Terramund', subject: 'Geografia'  },
    { slug: 'globish',   name: 'Globish',   subject: 'Ingl�s'     }
  ];
